      ...
      <main className="p-6 space-y-6 pb-20 bg-white dark:bg-black">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 rounded-xl bg-white dark:bg-black text-black dark:text-white placeholder-gray-500 border border-black dark:border-white focus:outline-none text-sm"
            value={searchQuery}
