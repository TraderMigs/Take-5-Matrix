      ...
      <div className="space-y-3">
          ...
          >
            ...
            <div className="flex items-center space-x-2">
              <Button
                ...
                className="bg-sage-green hover:bg-green-600 text-white px-4 py-2 rounded-lg transition-colors"
                size="sm"
              >
                <Phone size={16} />
              </Button>
        ...
        <Dialog open={isAddingContact} onOpenChange={setIsAddingContact}>
          <DialogTrigger asChild>
            <Button
              variant="outline"
              className="w-full border-2 border-dashed border-gray-300 hover:border-calm-teal p-4 rounded-xl transition-colors text-center text-gray-600 hover:text-calm-teal"
            >
